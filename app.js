...
const App = (function (ItemCtrl, UICtrl, StorageCtrl) {
  ...
  const itemUpdateSubmit = (e) => {
    ...
    // console.log('Test App.itemUpdateSubmit: test passed')

    if (e.target.classList.contains('edit-item')) {
      //& Test: ensure edit icons are registering click events
      //   console.log('Test.App.itemUpdateSubmit: edit item clicked')
      const listId = e.target.parentNode.parentNode.id
      //& Test: ensure we're grabbing the correct list ID for each item in list
      //   console.log('Test.App.itemUpdateSubmit, listId: ', listId)
      ...
      //   console.log('Test.App.itemUpdateSubmit, listIdArr: ', listIdArr)
      ...
      //   console.log('Test.App.itemUpdateSubmit, itemToEdit: ', itemToEdit)
